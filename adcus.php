...
<div class="container">
    ...
    <label for="email" style="text-align: left; display: block;">
        ...
        <label for="weight">Package Price(kg):</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get the height from the form
    $height = $_POST["height"];

    // Assuming a fixed price per unit of height (e.g., $2 per cm)
    $price = $height * 2;

    echo "<p>The price for a package with a height of $height cm is: $$price</p>";
